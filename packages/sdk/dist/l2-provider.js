...
exports.asL2Provider = exports.isL2Provider = exports.estimateL2GasCost = exports.estimateTotalGasCost = exports.estimateL1GasCost = exports.estimateL1Gas = exports.overhead = exports.scalar = exports.decimals = exports.getL1GasPrice = void 0;
...
const connectGasPriceOracle = (provider) => {
    return new ethers_1.Contract(contracts_1.predeploys.BVM_GasPriceOracle, (0, contracts_1.getContractInterface)('OVM_GasPriceOracle'), (0, utils_1.toProvider)(provider));
};
const connectBedrockGasPriceOracle = (provider) => {
    return new ethers_1.Contract(contracts_1.predeploys.BVM_GasPriceOracle, (0, contracts_bedrock_1.getContractInterface)('GasPriceOracle'), (0, utils_1.toProvider)(provider));
};
...
const decimals = async (l2Provider) => {
    const gpo = connectGasPriceOracle(l2Provider);
    return gpo.decimals();
};
exports.decimals = decimals;
const scalar = async (l2Provider) => {
    const gpo = connectGasPriceOracle(l2Provider);
    return gpo.scalar();
};
exports.scalar = scalar;
const overhead = async (l2Provider) => {
    const gpo = connectGasPriceOracle(l2Provider);
    return gpo.overhead();
};
...
const estimateL1GasCost = async (l2Provider, tx) => {
    ...
    const l1Fee = await gpo.getL1Fee((0, transactions_1.serialize)({
        data: tx.data,
        to: tx.to,
        gasPrice: tx.gasPrice,
        type: tx.type,
...
const estimateL2GasCost = async (l2Provider, tx) => {
    const totalGasCost = await (0, exports.estimateTotalGasCost)(l2Provider, tx);
...
const asL2Provider = (provider) => {
    ...
    l2Provider.decimals = async () => {
        return (0, exports.decimals)(l2Provider);
    };
    l2Provider.scalar = async () => {
        return (0, exports.scalar)(l2Provider);
    };
    l2Provider.overhead = async () => {
        return (0, exports.overhead)(l2Provider);
    };
