...
export declare const decimals: (l2Provider: ProviderLike) => Promise<BigNumber>;
export declare const scalar: (l2Provider: ProviderLike) => Promise<BigNumber>;
export declare const overhead: (l2Provider: ProviderLike) => Promise<BigNumber>;
