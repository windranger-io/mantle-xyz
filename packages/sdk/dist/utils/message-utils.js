...
const hashLowLevelMessage = (message) => {
    return (0, core_utils_1.hashWithdrawal)(message.messageNonce, message.sender, message.target, message.mntValue, message.ethValue, message.minGasLimit, message.message);
};
