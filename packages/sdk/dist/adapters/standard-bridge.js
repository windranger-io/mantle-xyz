...
class StandardBridgeAdapter {
    ...
    async getDepositsByAddress(address, opts) {
        ...
        return events
            ...
            return (!(0, core_utils_1.hexStringEquals)(event.args.l1Token, ethers_1.ethers.constants.AddressZero) &&
                !(0, core_utils_1.hexStringEquals)(event.args.l2Token, contracts_1.predeploys.BVM_ETH));
        })
            .map((event) => {
            return {
    ...
    async supportsTokenPair(l1Token, l2Token) {
        ...
        try {
            ...
            if ((0, core_utils_1.hexStringEquals)((0, utils_1.toAddress)(l2Token), ethers_1.ethers.constants.AddressZero)) {
                return false;
            }
            if ((0, core_utils_1.hexStringEquals)((0, utils_1.toAddress)(l2Token), contracts_1.predeploys.LegacyERC20Mantle)) {
                return true;
            }
            ...
            if ((0, core_utils_1.hexStringEquals)(remoteL1Token, (0, utils_1.toAddress)('0x1a4b46696b2bb4794eb3d4c26f1c55f9170fa4c5'))) {
                return true;
            }
