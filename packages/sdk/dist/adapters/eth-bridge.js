    ...
    constructor() {
        ...
        this.populateTransaction = {
            approve: async (l1Token, l2Token, amount, opts) => {
                ...
                const token = new ethers_1.Contract((0, utils_1.toAddress)(l2Token), (0, contracts_bedrock_1.getContractInterface)('OptimismMintableERC20'), this.messenger.l2Provider);
                return token.populateTransaction.approve(this.l2Bridge.address, amount, (opts === null || opts === void 0 ? void 0 : opts.overrides) || {});
            },
