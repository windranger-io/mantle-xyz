...
export type Coin98WalletConnectorOptions = InjectedConnectorOptions;
// declare global {
//   interface Window {
//     bybitWallet?: {
//       bnbSign?: (
...
declare global {
  interface Window {
    coin98?: {
      provider: WindowProvider & { isCoin98: boolean; isReady: boolean };
    };
  }
}

export function getCoin98WalletProvider(): WindowProvider | undefined {
  const isWallet = (coin98: NonNullable<Window["coin98"]>) => {
    // Identify if Trust Wallet injected provider is present.
    const provider = !!coin98.provider.isCoin98;
  ...
  if (isWallet(window.coin98 as NonNullable<Window["coin98"]>)) {
...
export class Coin98WalletConnector extends InjectedConnector {
  ...
  constructor({
    ...
    chains?: Chain[];
    options?: Coin98WalletConnectorOptions;
  } = {}) {
    const options = {
