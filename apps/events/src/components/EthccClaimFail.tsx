      ...
      <div className="w-full min-h-screen flex flex-col z-10 px-4 pt-28 pb-6">
        <div className="flex flex-col items-center text-center space-y-4 mx-auto">
          ...
          <Typography
            ...
            className="max-w-[350px] font-medium text-[42px] leading-[50px] tracking-[-0.14rem]"
          >
            Seems like <br /> your $MNT has been claimed already
          </Typography>
          <Link
            href={CHAINLIST}
