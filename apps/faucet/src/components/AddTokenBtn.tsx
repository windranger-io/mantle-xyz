...
import { Button, MyTooltip } from "@mantle/ui";
import { useState } from "react";
import { NETWORKS, L1_CHAIN_ID } from "@config/constants";
...
export default function AddTokenBtn({
  ...
  return (
    <Button
      ...
      variant="ghost"
      // className="px-1 py-0"
      className={`${effect && "animate-downUp"} ${className}`}
      onClick={() => {
        setEffect(true);
        addToken({
    ...
    >
      <MyTooltip
        side="top"
        sideOffset={10}
        title={<MetamaskIcon width={iconWidth} height={iconHeight} />}
        content={
          <div className="text-black text-sm">
            <p>Add MNT address to the wallet</p>
          </div>
        }
      />
    </Button>
