...
const DynamicMantleDepositETH = dynamic(() => import('src/components/demos/MantleDepositETH'), {
  ssr: false
});

const DynamicMantleWithdrawERC20 = dynamic(() => import('src/components/demos/MantleWithdrawERC20'), {
  ssr: false
});

const DynamicMantleDepositERC20 = dynamic(() => import('src/components/demos/MantleDepositERC20'), {
  ssr: false
});

const DynamicMantleWithdrawalsHistory = dynamic(() => import('src/components/demos/MantleWithdrawalsHistory'), {
  ssr: false
});

const DynamicMantleDepositsHistory = dynamic(() => import('src/components/demos/MantleDepositsHistory'), {
  ssr: false
});
