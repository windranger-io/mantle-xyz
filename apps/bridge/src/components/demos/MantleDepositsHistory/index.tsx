...
function MantleDepositsHistory() {
  ...
  const mantleBridgeBackendApiUrl =
    `${MANTLE_BRIDGE_BACKEND_API_URL_PREFIX}/${DEPOSITS_LABEL}/${address}?${queryParameters.toString()}`;
