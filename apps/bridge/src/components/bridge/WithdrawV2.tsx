...
const tabOptions = [
  {
    ...
    hover: `Bridge any token from Mantle Network. This may take up to 7 days to process.`,
  },
  {
    title: "A third party bridge",
    mobile: "3rd party bridge",
    hover: `Bridge to multiple chains (only for selected tokens). Processing time may vary across chains.`,
  },
];
