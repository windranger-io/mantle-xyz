...
function MantleSDKProvider({ children }: MantleSDKProviderProps) {
  ...
  const crossChainMessenger = React.useMemo(() => {
    ...
    return new CrossChainMessenger({
      ...
      l1SignerOrProvider:
        connectedChainID === GOERLI_CHAIN_ID ? goerliSigner : goerliProvider,
      l2SignerOrProvider:
  ...
  return (
    ...
    <MantleSDKContext.Provider value={{ crossChainMessenger }}>
      {children}
...
export { MantleSDKProviderWithErrorBoundary as MantleSDKProvider, useMantleSDK }
